...
from ..resnet import resnet101, resnet50, ResNet50_Weights, ResNet101_Weights
...
__all__ = [
    ...
    # Added resnet101 weights
    "FasterRCNN_ResNet101_FPN_Weights",
    "FasterRCNN_ResNet50_FPN_V2_Weights",
    "FasterRCNN_MobileNet_V3_Large_FPN_Weights",
    "FasterRCNN_MobileNet_V3_Large_320_FPN_Weights",
    "fasterrcnn_resnet50_fpn",
    # Added resnet101 backbone
...
class FasterRCNN_ResNet101_FPN_Weights(WeightsEnum):
    COCO_V1 = Weights(
        url="https://ababino-models.s3.amazonaws.com/resnet101_7a82fa4a.pth",
        transforms=ObjectDetection,
        meta={
            **_COMMON_META,
            "num_params": 0,
...
@register_model()
@handle_legacy_interface(
    weights=("pretrained", FasterRCNN_ResNet101_FPN_Weights.COCO_V1),
    weights_backbone=("pretrained_backbone", ResNet101_Weights.IMAGENET1K_V1),
)
def fasterrcnn_resnet101_fpn(
    *,
    weights: Optional[FasterRCNN_ResNet101_FPN_Weights] = None,
    progress: bool = True,
    num_classes: Optional[int] = None,
    ...
    **kwargs: Any,
    ...
    weights = FasterRCNN_ResNet101_FPN_Weights.verify(weights)
    ...
    if weights is not None:
        model.load_state_dict(weights.get_state_dict(progress=progress, check_hash=True))
        if weights == FasterRCNN_ResNet101_FPN_Weights.COCO_V1:
            overwrite_eps(model, 0.0)
    return model
